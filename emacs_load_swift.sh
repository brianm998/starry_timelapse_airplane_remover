...
find ~/git/nighttime_timelapse_airplane_remover/kht/Sources -name '*.cpp' -exec emacsclient -n '{}' ';'
find ~/git/nighttime_timelapse_airplane_remover/kht/Sources -name '*.hpp' -exec emacsclient -n '{}' ';'
