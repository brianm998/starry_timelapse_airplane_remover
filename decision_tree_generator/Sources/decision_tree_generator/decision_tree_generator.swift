...
*/
    ...
    func generate_tree() {
        ...
        Task {
            ...
            let filename = "../NtarCore/Sources/NtarCore/OutlierGroupDecisionTree_TEST.swift"
                      ...
                      and should_not_paint_test_data: [OutlierGroupValues]) -> String
    {
        ...
        // XXX add time it took to create it to comments
        return """
          /*
                          ...
                          indent: Int) -> DecisionTree
    {
        ...
        if let bestType = bestType {
            ...
            // XXX use a TaskGroup to recurse here
