...
fileprivate let airplane_keys_over_lines_avg = $airplane_value
fileprivate let airplane_mid_value_avg = $airplane_mid_value

fileprivate let non_airplane_keys_over_lines_avg = $non_airplane_value
fileprivate let non_airplane_mid_value_avg = $non_airplane_mid_value

fileprivate let keys_over_lines_avg = $keys_over_lines_avg
fileprivate let mid_index_avg = $mid_index_avg
