...
Pod::Spec.new do |s|
  ...
  s.name         = "StarDecisionTrees"
  s.version      = "0.1.2"
  s.summary      = "star auto generated decision trees"

  s.description  = <<-DESC
  star decision trees for deciding the paintability of outlier groups
